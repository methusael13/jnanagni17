...
<html lang="en">
    <head>
        ...
        <meta name="fritolay" <?php if($loggedin): ?> content="true" <?php else: ?> content="false" <?php endif; ?> />
    ...
    <body>
        ...
        <div class="hidden" id="pre-load-bg">
            ...
            <img src=<?php echo e("res/images/event-cat/" . $cat->getID() . ".jpg"); ?> alt="">
        ...
        <div class="header">
            <div class="header-content page-content-margin" id="hc-id">
                ...
                <div class="reg" id="reg-id">
                    ...
                    <a href="#" <?php if($loggedin): ?> class="pad2 pre-reg animatable-co remove-o hidden" <?php else: ?> class="pad2 pre-reg animatable-co" <?php endif; ?> id="pre-reg-but">
                        Login | Register
                    </a>
                    <div <?php if($loggedin): ?> class="pad2 pre-reg animatable-all" <?php else: ?> class="pad2 pre-reg animatable-all remove-o hidden" <?php endif; ?> id="user-btn">
                        <span class="btn-icon"><i class="fa fa-user-o" aria-hidden="true"></i></span>
                        <span class="btn-text" id="user-btn-text"><?php echo e($fname); ?></span>
            ...
            <div class="content-info">
                <div class="reg-dialog modal animatable-o remove-o hidden" id="reg-dialog">
                    <div class="section-reg">
                        ...
                        <?php echo e(Form::open(['url' => '/pre-register', 'method' => 'POST', 'class' => 'form animatable-o remove-o hidden', 'id' => 'form-reg'])); ?>
                        ...
                        <?php echo e(Form::open(['url' => '/login', 'method' => 'POST', 'class' => 'form animatable-o', 'id' => 'form-login'])); ?>
        ...
        <div class="nav-dialog modal animatable-o remove-o hidden" id="nav-dialog-menu">
            ...
            <div class="nav-content">
                ...
                <div class="nav-info hidden" id="nf-schedule"><?php echo $__env->make('schedule', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></div>
                <div class="nav-info hidden" id="nf-sponsors">
                <?php $sp_cnt = $sponsors['count']; ?>
                <?php for($i = 0; $i < $sp_cnt; $i++): ?>
                    <div class="square-item animatable-f" style='background-image: url("<?php echo e($sponsors["path"] . $i . ".jpg"); ?>");'></div>
                <?php endfor; ?>
                </div>
                ...
                <div class="nav-info hidden" id="nf-contact">
                    <div class="nf-contact-section" id="nfcs-ft">
                        ...
                        <?php $__currentLoopData = $ftContacts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <div class="contact-item">
                            <div id="name"><?php echo e($contact[0]); ?></div>
                            <div id="phone">(+91)&nbsp<?php echo e($contact[1]); ?></div>
                            <div id="title"><?php echo e($contact[2]); ?></div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                        </div>
                    </div>
                ...
                <div class="nav-info hidden" id="nf-dev">
                    <div class="nf-contact-section">
                        <div class="nf-contact-section-data">
                        <?php $__currentLoopData = $developers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dev): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <div class="contact-item">
                            <div class="dp-section">
                                <div class="dp" style='background-image: url("<?php echo e($dev[3]); ?>");'></div>
                            </div>
                            <div id="name"><?php echo e($dev[0]); ?></div>
                            <div id="phone"><?php echo e($dev[1]); ?></div>
                            <div id="title"><?php echo e($dev[2]); ?></div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                        </div>
                    </div>
        ...
        <?php echo $__env->make('evt-details-dialog', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
